...
# ---------- protected resource: eye-calibration points ----------
# NOTE: in-memory store is fine for a demo / single instance. For real multi-user
# use, swap this for a real database table keyed by user/device.
_calibration = {"left": None, "right": None}
...
def reset_calibration():
    _calibration["left"] = None
    _calibration["right"] = None
    return jsonify(_calibration)
